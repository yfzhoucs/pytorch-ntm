...
@attrs
class DecreaseTaskParams(object):
    name = attrib(default="decrease-task")
...
@attrs
class DecreaseTaskModelTraining(object):
    params = attrib(default=Factory(DecreaseTaskParams))
    net = attrib()
    dataloader = attrib()
    criterion = attrib()
    optimizer = attrib()
