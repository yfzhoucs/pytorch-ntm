...
@attrs
class AddOneTellParityTaskParams(object):
    name = attrib(default="addone-tellparity-bcd")
...
@attrs
class AddOneTellParityModelTraining(object):
    params = attrib(default=Factory(AddOneTellParityTaskParams))
    net = attrib()
    dataloader = attrib()
    criterion = attrib()
    optimizer = attrib()
